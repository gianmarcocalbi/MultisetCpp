...
private:
	...
	/**
		...
		@param obj Elemento da aggiungere al multiset.
		@n Quantità da aggiungere dell'elemento obj.
	*/
...
public:
	...
	*/
	...
	private:
		...
		size_type n;				///< Se nel multiset sono presenti più elementi uguali "A" (ovvero S = {A,A,A,X...}), allora n tiene in memoria che curr punta all' n-esimo elemento "A". Inizialmente n = 0.

		/**
			Costruttore privato.
			@param ptr Puntatore al nodo a cui punterà curr.
		*/
